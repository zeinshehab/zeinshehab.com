...
- **CLI Tooling:** A command-line interface for generating commitments, producing proofs, and verifying moves step-by-step. Designed for reproducibility and debugging.
